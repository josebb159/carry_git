...
Route::get('/_run_migrations_temp_654321', function () {
    try {
...
Route::middleware(['auth', 'verified'])->group(function () {
    ...
    // Clients
    Route::middleware(\App\Http\Middleware\RedirectIfClient::class)->group(function () {
        ...
        // Fleet (Admin/Agent)
        Route::middleware('role:admin|agent')->group(
            function () {
